...
*
*     BEGIN NBODY6MP-Scaling parameters for MS lifetime
      real*8 tmscale,ascale,bscale,mscale
      parameter(ascale=-1.05980983377)
      parameter(bscale=-2.78101476398)
      parameter(mscale=1.0)
*     END NBODY6MP
...
* BEGIN NBODY6MP - SCALE TM GIVEN HELIUM ABU
      if (ypop.ne.0.0)
        tm=tm*(10.0**(a*(ypop-0.248)**2.0+b*(ypop-0.248)))
        tscls(1)=tm/MAX(zpars(8),thookf(mass))
      end if
* END NBODY6MP
*
