***
      SUBROUTINE zcnsts(y,z,zpars)
* 
      implicit none
      integer kw
*
      include 'zdata.h'
*     BEGIN NBODY6MP - INCLUDE Y AS INPUT AND SET EQUAL TO ZPARS(15)
      real*8 y,z,zpars(20)
*     END NBODY6MP
...
*             BEGIN NBODY6MP
*             15; 0 if Helium abundance is zpars(12), non-zero if multiple-populations
*             END NBDOY6MP
*
*
*       ------------------------------------------------------------
...
* 
      zpars(14) = z**0.4d0
*     BEGIN NBODY6MP - Set helium fraction in case of multiple populations
      zpars(15)=y
*     END NBODY6MP
*
      return
