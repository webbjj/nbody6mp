...
*
*     BEGIN NBODY6MP-Scaling parameters for MS lifetime for m<mscale
      real*8 ascale,bscale,mscale
      parameter(ascale=-1.05980983377)
      parameter(bscale=-2.78101476398)
      parameter(mscale=50.0)
*     END NBODY6MP
...
*       Scale to tm from zpars(12) to Y=0.248
     ...
     &bscale*(zpars(12)-0.248)))

*       Scale to tm for Y=zpars(15) 
        tm=tm*(10.0**(ascale*(zpars(15)-0.248)**2.0+
     &bscale*(zpars(15)-0.248)))
