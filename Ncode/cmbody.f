...
*
     ...
     &                ECOLL1,RCOLL,QPERI,ISTAR(NMX),ICOLL,ISYNC,NDISS1
      ...
      SAVE FIRST
      DATA FIRST /.TRUE./
*     BEGIN NBODY6MP - NEED ARRAY FOR TEMPORARY SAVE
      REAL*8 MPTYPE_SAVE
*     END NBODY6MP
*
*
...
*       Ensure NAME of the heaviest body is new progenitor.
      IF (BODY(I2).GT.BODY(I1)) THEN
          ...
          NAME(I1) = NAME(I2)
          NAME(I2) = NAM1
*         BEGIN NBODY6MP - ENSURE MPTYPE OF HEAVIEST OBJECT IS NEW PROGENITOR
          MPTYPE_SAVE=MPTYPE(I1)
          MPTYPE(I1)=MPTYPE(I2)
          MPTYPE(I2)=MPTYPE_SAVE
*         END NBODY6MP
      END IF
*
