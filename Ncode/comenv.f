...
*     BEGIN NBODY6MP - INCLUDE STAR IDS
      SUBROUTINE COMENV(I1,M01,M1,MC1,AJ1,JSPIN1,KW1,
     &                  I2,M02,M2,MC2,AJ2,JSPIN2,KW2,ECC,SEP,COEL)
*     END NBODY6MP
*
...
*
         ...
         OORB = TWOPI/TB
*
*        BEGIN NBODY6MP - USE MPTYPE OF MORE MASSIVE STAR
         IF (KZ(50).GT.1) THEN
           IF(M1.GT.M2)THEN
               ZPARS=ZPARSP(1:20,MPTYPE(I1))
           ELSE
