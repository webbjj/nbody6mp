...
*            BEGIN NBODY6MP
             ...
             ELSE
               DMR(K) = MLWIND(KW,LUM,R1,M1,MC,RLPERI,ZPOP(MPTYPE(J)))
             END IF
*            END NBODY6MP
             DMA(K) = 0.D0
             TMS(K) = TM
...
*             BEGIN NBODY6MP
     ...
     &                    ZMET,ECC,TK,JSPIN(1),JSPIN(2),CH5
              ELSE
                IF (MASS(1).GT.MASS(2)) THEN
                  WRITE(85,95)NAME(J1),NAME(J2),KSTAR(J1),KSTAR(J2),
     &                    KSTAR(I),TPHYS,AJ(1),AJ(2),
     &                    MASS0(1),MASS0(2),MASS(1),MASS(2),
     &                    ZPOP(MPTYPE(J1)),ECC,TK,JSPIN(1),JSPIN(2),CH5
                ELSE
                  WRITE(85,95)NAME(J1),NAME(J2),KSTAR(J1),KSTAR(J2),
     &                    KSTAR(I),TPHYS,AJ(1),AJ(2),
     &                    MASS0(1),MASS0(2),MASS(1),MASS(2),
     &                    ZPOP(MPTYPE(J2)),ECC,TK,JSPIN(1),JSPIN(2),CH5
...
*            BEGIN NBODY6MP - TAKE MORE MASSIVE STAR
      IF (KZ(50).GT.1) THEN
          IF (BODY(J1).GT.BODY(J2))THEN
            ZPARS=ZPARSP(1:20,MPTYPE(J1))
          ELSE
            ZPARS=ZPARSP(1:20,MPTYPE(J2))
          END IF
      END IF
*     END NBODY6MP
...
*     &               ECC,SEP,COALS)
         CALL comenv(J1,MASS0(1),MASS(1),MASSC(1),AJ(1),JSPIN(1),KW1,
     &               J2,MASS0(2),MASS(2),MASSC(2),AJ(2),JSPIN(2),KW2,
     &               ECC,SEP,COALS)
*        END NBODY6MP
     ...
     &                MASS(K),TK,ZMET,ECC,TK,JSPIN(K),TK,CH5
          ELSE
            IF(MASS(1).GT.MASS(2))THEN
              WRITE(85,95)NAME(J1),NAME(J2),KW1,KW2,KSTAR(I),
     &                TPHYS,AJ(K),TK,MASS0(K),MASS0(3-K),
     &                MASS(K),TK,ZPOP(MPTYPE(J1)),ECC,TK,JSPIN(K),TK,CH5
            ELSE
              WRITE(85,95)NAME(J1),NAME(J2),KW1,KW2,KSTAR(I),
     &                TPHYS,AJ(K),TK,MASS0(K),MASS0(3-K),
     &                MASS(K),TK,ZPOP(MPTYPE(J2)),ECC,TK,JSPIN(K),TK,CH5
            END IF
          END IF
*         END NBODY6MP
*
     ...
     &               MASS(1),MASS(2),ZMET,ECC,TK,JSPIN(1),JSPIN(2),CH5
         ELSE
           IF(MASS(1).GT.MASS(2)) THEN
             WRITE(85,95)NAME(J1),NAME(J2),KSTAR(J1),KSTAR(J2),KSTAR(I),
     &               TPHYS,AJ(1),AJ(2),MASS0(1),MASS0(2),
     &               MASS(1),MASS(2),ZPOP(MPTYPE(J1)),ECC,TK,JSPIN(1),
     &               JSPIN(2),CH5
           ELSE
             WRITE(85,95)NAME(J1),NAME(J2),KSTAR(J1),KSTAR(J2),KSTAR(I),
     &               TPHYS,AJ(1),AJ(2),MASS0(1),MASS0(2),
     &               MASS(1),MASS(2),ZPOP(MPTYPE(J2)),ECC,TK,JSPIN(1),
     &               JSPIN(2),CH5
           END IF
         END IF
*        END NBODY6MP
