...
*** FRenaud
*     BEGIN NOBDY6MP - NEW COMMON BLOCK FOR MP TREATMENT
      COMMON/MP/     NPOPS(NPOPSMAX),
     &               YPOP(NPOPSMAX),ZPOP(NPOPSMAX),
     &               ZPARSP(20,NPOPSMAX),MPTYPE(NMAX)
*     END NBODY6MP
...
*** FRenaud
*** BEGIN NBODY6MP
        write (J) (npops(k),k=1,npopsmax),(ypop(k),k=1,npopsmax),
     &(zpop(k),k=1,npopsmax),((zparsp(k,i),k=1,20),i=1,npopsmax)
        write (J) (mptype(k),k=1,ntot)
*** END NBDOY6MP
...
*** BEGIN NBODY6MP
        read (J) (npops(k),k=1,npopsmax),(ypop(k),k=1,npopsmax),
     &(zpop(k),k=1,npopsmax),((zparsp(k,i),k=1,20),i=1,npopsmax)
        read (J) (mptype(k),k=1,ntot)
*** END NBDOY6MP
